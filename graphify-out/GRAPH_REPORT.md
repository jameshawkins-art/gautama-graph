...
## Corpus Check
- 80 files · ~58,568 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 669 nodes · 983 edges · 55 communities (47 shown, 8 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 56 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0baaa66e`
...
- `NewEngine()` --calls--> `NewDefaultIPCWorkerPool()`  [INFERRED]
  internal/auditor/engine.go → internal/auditor/ipc_bridge.go
- `NewDefaultEngine()` --calls--> `NewDefaultIPCWorkerPool()`  [INFERRED]
  internal/auditor/engine.go → internal/auditor/ipc_bridge.go
...
### Community 1 - "auditor/types.go"
Cohesion: 0.06
Nodes (41): ASTParser, Config, CrossPackageEvaluator, DefaultCrossPackageEvaluator, DefaultInterfaceResolver, DefaultPackageSymbolIndexer, DefaultSelectorEvaluator, Engine (+33 more)

### Community 2 - "doc_auditor.go"
Cohesion: 0.14
Nodes (19): BrokenLinkResult, DefaultDocGraphParser, DefaultDocGraphStore, DocGraphAuditor, DocGraphParser, DocGraphStore, DocNodeResult, main() (+11 more)

### Community 3 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 4 - "bug-step3.md"
Cohesion: 0.10
...
Cohesion: 0.20
Nodes (7): Coupling Constraints & Operational Rules, NEXUS PROTOCOL DIRECTIVE, CONTEXT & OBJECTIVE, 🕸️ MANDATORY GRAPHIFY KNOWLEDGE GRAPH DISCOVERY (TOKEN OPTIMIZATION), 📄 OUTPUT FILE REQUIREMENT, 🛑 PHASE 1 EXECUTION CONSTRAINTS, 🔒 STEP 1 CONTEXT ISOLATION & PROGRESSIVE DISCLOSURE
...
### Community 16 - "debugger-remediation.md"
Cohesion: 0.05
Nodes (34): 1. Minimal Surgical Patches & Repro-First, 2. IPC Bridge & Subprocess Resilience, 3. Concurrency & Mutex Discipline, Core Directives & Rules, Debugger & Remediation Persona Specification (`gautama-mechanic`), Deliverables & Meta-Artifacts, 1. Pillar 1: Go Interface Abstractions & Export Standards, 2. Pillar 2: Zero-Trust Path Confinement & Traversal Defense (+26 more)
...
Cohesion: 0.33
Nodes (6): 1. Antigravity 2.0 Dynamic Scaffolding & Prompt Ops Governance, 2. Context Hygiene & Anti-Bloat Governance, 3. Multi-Agent Orchestration & SDLC Gatekeeping, 4. Gautama Graph Engine Architecture & Integrity Governance, 5. Graphify Knowledge Graph & Token Optimization Mandate, Core Capabilities & Specializations
...
### Community 24 - "security-auditor.md"
Cohesion: 0.25
...
### Community 30 - "security-auditor/SKILL.md"
Cohesion: 0.18
Nodes (10): 1.1 Path Traversal Defense & Zero-Trust Filesystem Confinement, 1.2 Unsafe Memory & CGo Ban, 1.3 Subprocess Isolation & Command Injection Defense, 1.4 Dependency Vulnerability Auditing & Public API Tracking, 2.1 Security Audit Report (`security_audit_report.md`), 2.2 Security Compliance Checklist (`compliance_checklist.md`), 2.3 JSON Security Verification Meta-Artifact (`security_verification_meta.json`), Section 1: Core Behavioral Rules & Guardrails (+2 more)

### Community 35 - "Gautama Graph Master Product & Architecture Roadmap"
Cohesion: 0.22
Nodes (9): Architectural Subsystems Overview, Detailed Item Specifications, Executive Summary & Strategic Mission, Gautama Graph Master Product & Architecture Roadmap, Item 001: Encapsulated Graphify Binary Manager & Single-Entrypoint Orchestrator, Item 002: Deep AST Multi-Package Import & Interface Implementation Resolution, Item 003: Streaming AST IPC Bridge & Persistent Subprocess Daemon Pool, Master Feature Roadmap Table (+1 more)

### Community 38 - "context.Context"
Cohesion: 0.07
Nodes (31): AuditedEdge, CandidateEdge, DefaultIPCWorkerPool, DefaultPythonASTBridge, GraphData, IPCCommand, IPCRequest, IPCResponse (+23 more)
...
Cohesion: 0.09
Nodes (32): main(), time.Duration, DocGraphAuditorService, ASTGraphAuditorService, NewDefaultReleaseDownloader(), NewDefaultBinaryManager(), ResolveDefaultCacheDir(), ResolvePlatformTarget() (+24 more)
...
## Knowledge Gaps
- **302 isolated node(s):** `github.com/jameshawkins-art/gautama-graph`, `IPCSession`, `OrchestratorService`, `agent-execute.sh script`, `gautama-studio-execute.sh script` (+297 more)
...
- **What connects `github.com/jameshawkins-art/gautama-graph`, `IPCSession`, `OrchestratorService` to the rest of the system?**
  _302 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `bug-step1.md` be split into smaller, more focused modules?**
  _Cohesion score 0.09523809523809523 - nodes in this community are weakly interconnected._
- **Should `auditor/types.go` be split into smaller, more focused modules?**
  _Cohesion score 0.06346153846153846 - nodes in this community are weakly interconnected._
- **Should `doc_auditor.go` be split into smaller, more focused modules?**
  _Cohesion score 0.13538461538461538 - nodes in this community are weakly interconnected._
- **Should `What You Must Do When Invoked` be split into smaller, more focused modules?**
  _Cohesion score 0.08 - nodes in this community are weakly interconnected._
- **Should `bug-step3.md` be split into smaller, more focused modules?**
  _Cohesion score 0.09523809523809523 - nodes in this community are weakly interconnected._